...
<?php $__env->startSection('title', 'Profil - Kafe Angin Semilir'); ?> 
        ...
        <div class="swiper profilSwiper h-full">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('images/profil-header_1.jpg')); ?>" alt="Suasana Kafe 1" class="w-full h-full object-cover">
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('images/profil-header_2.jpg')); ?>" alt="Suasana Kafe 2" class="w-full h-full object-cover">
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('images/profil-header_3.jpg')); ?>" alt="Suasana Kafe 3" class="w-full h-full object-cover">
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('images/profil-header_4.jpg')); ?>" alt="Suasana Kafe 3" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 1.jpg')); ?>" alt="Galeri 1" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 2.jpg')); ?>" alt="Galeri 2" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 3.jpg')); ?>" alt="Galeri 3" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 4.jpg')); ?>" alt="Galeri 4" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 5.jpg')); ?>" alt="Galeri 5" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 6.jpg')); ?>" alt="Galeri 6" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 7.jpg')); ?>" alt="Galeri 7" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
            <div class="overflow-hidden rounded-[30px] shadow-lg shadow-black/65 h-[240px] group">
                <img src="<?php echo e(asset('images/Galeri 8.jpg')); ?>" alt="Galeri 8" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\semilir2\resources\views/profil.blade.php ENDPATH**/ ?>