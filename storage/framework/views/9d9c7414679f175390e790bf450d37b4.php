    ...
    <div class="bg-white rounded-[30px] shadow-2xl p-10 w-full max-w-4xl relative overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.menu.update', $menu->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <?php if($menu->foto): ?>
                    <div class="mb-3 ml-2">
                        <img src="<?php echo e(asset('storage/'.$menu->foto)); ?>" class="w-24 h-24 object-cover rounded-2xl border-2 border-gray-200 shadow-sm">
...
</html><?php /**PATH C:\xampp\htdocs\semilir\resources\views/admin/menu/edit.blade.php ENDPATH**/ ?>