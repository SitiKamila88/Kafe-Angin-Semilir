...
@section('title', 'Kafe Angin Semilir - Beranda')

{{-- CSS KHUSUS UNTUK HALAMAN INI (Optional: Animasi Floating) --}}
@push('styles')
<style>
...
@section('content')
    ...
    {{-- SEKS HERO: Bagian landing utama dengan teks promosi dan gambar piring makanan --}}
    <section class="relative w-full pt-24 pb-32 overflow-hidden -mt-24">
        

        {{-- KONTAINER UTAMA: Mengatur layout grid 2 kolom untuk desktop, memusatkan konten --}}
        <div class="container mx-auto px-4 relative z-10 grid md:grid-cols-2 gap-8 items-center h-full">
            
            {{-- BAGIAN KIRI: Teks hero dengan judul, deskripsi, rating, dan tombol pesan --}}
            ...
            {{-- BAGIAN KANAN: Tampilan gambar piring makanan dengan efek animasi daun --}}
            <div class="relative h-[600px] w-full hidden md:flex items-center justify-center">
                
                {{-- DAUN-DAUN ANIMASI: Elemen dekoratif dengan animasi mengapung --}}
                <img src="{{ asset('images/dauns.svg') }}" class="absolute top-0 right-10 w-24 z-50 animate-float">
                <img src="{{ asset('images/dauns.svg') }}" class="absolute bottom-20 left-0 w-20 z-50 opacity-80 animate-float" style="animation-delay: 1s;">
                <img src="{{ asset('images/dauns.svg') }}" class="absolute top-1/2 right-0 w-16 z-50 opacity-70 animate-float" style="animation-delay: 2s;">

                {{-- PIRING LATAR BELAKANG: Gambar ayam dan telur sebagai latar --}}
                {{-- Ayam (Kanan Atas) --}}
                <img src="{{ asset('images/ayam_display.png') }}" class="absolute top-10 right-0 w-64 h-auto object-contain z-20 drop-shadow-2xl transition-transform hover:scale-105">

                {{-- Telur (Kiri Bawah) --}}
                <img src="{{ asset('images/telur_display.png') }}" class="absolute bottom-10 left-4 w-64 h-auto object-contain z-20 drop-shadow-2xl transition-transform hover:scale-105">

                {{-- PIRING UTAMA: Gambar nila sebagai fokus utama --}}
                {{-- Nila (Tengah) --}}
                <img src="{{ asset('images/nila_display.png') }}" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] h-auto object-contain z-30 drop-shadow-[0_35px_35px_rgba(0,0,0,0.3)] transition-transform hover:scale-110">
    ...
    {{-- SEKS SELAMAT DATANG: Bagian pengenalan kafe dengan gambar galeri dan deskripsi --}}
    <section class="relative container mx-auto px-4 py-16 md:py-24">
       <div class="text-center max-w-4xl mx-auto mb-16">
        ...
        {{-- GRID LAYOUT: 2 kolom untuk desktop, gambar kiri teks kanan --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            {{-- GALERI GAMBAR: Grid 2x2 dengan gambar interior kafe --}}
            <div class="grid grid-cols-2 gap-4 h-[450px]">
                <div class="row-span-2 relative h-full">
                    <img src="{{ asset('images/pintumasuk.jpeg') }}" class="w-full h-full object-cover shadow-xl rounded-tl-[80px] rounded-br-[80px] rounded-tr-none rounded-bl-none hover:scale-[1.02] transition-transform duration-500">
                </div>
                <div class="relative h-[217px]">
                    <img src="{{ asset('images/Galeri 2.jpg') }}" class="w-full h-full object-cover shadow-xl rounded-tr-[60px] rounded-bl-[60px] rounded-tl-none rounded-br-none hover:scale-[1.02] transition-transform duration-500">
                </div>
                <div class="relative h-[217px]">
                    <img src="{{ asset('images/pintumasuk2.jpeg') }}" class="w-full h-full object-cover shadow-xl rounded-tr-[60px] rounded-bl-[60px] rounded-tl-none rounded-br-none hover:scale-[1.02] transition-transform duration-500">
                </div>
            </div>

            {{-- TEKS DESKRIPSI: Penjelasan tentang kafe dan tombol navigasi --}}
            <div class="text-left pl-0 lg:pl-10">
                ...
                <!-- BUTTON SELAMAT DATANG -->
                <div class="flex flex-wrap gap-4">
                    <a href="{{ url('/profil') }}" class="inline-flex items-center justify-center bg-[#F9A826] text-white px-8 py-3 rounded-full font-bold shadow-lg shadow-orange-500/20 hover:bg-[#E79A24] transition-transform hover:scale-105">
                        Lebih Lanjut <i class="fas fa-chevron-right ml-2 text-sm"></i>
                    </a>
                    <a href="{{ url('/kontak') }}" class="inline-flex items-center justify-center bg-[#F9A826] text-white px-8 py-3 rounded-full font-bold shadow-lg shadow-orange-500/20 hover:bg-[#E79A24] transition-transform hover:scale-105">
    ...
    {{-- SEKS MENU TERLARIS: Tampilan menu andalan dengan gambar dan harga --}}
    <section class="relative container mx-auto px-4 py-16 md:py-24 text-center">
        {{-- JUDUL DAN DESKRIPSI SEKS --}}
        ...
        {{-- GRID MENU: 5 kolom untuk desktop, menampilkan kartu menu --}}
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-24">
            <div class="relative w-full mt-8 group text-left">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 w-36 h-36 z-20">
                    <img src="{{ asset('images/nila_display.png') }}" alt="Lalapan Nila" class="w-full h-full object-cover rounded-full drop-shadow-2xl transition-transform duration-300 group-hover:scale-110">
            ...
            <div class="relative w-full mt-8 group text-left">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 w-36 h-36 z-20">
                    <img src="{{ asset('images/ayam_display.png') }}" alt="Lalapan Ayam" class="w-full h-full object-cover rounded-full drop-shadow-2xl transition-transform duration-300 group-hover:scale-110">
                    <div class="absolute bottom-0 right-0 bg-white w-12 h-12 flex items-center justify-center rounded-full shadow-lg z-30 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
            ...
            <div class="relative w-full mt-8 group text-left">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 w-36 h-36 z-20">
                    <img src="{{ asset('images/telur_display.png') }}" alt="Lalapan Telur" class="w-full h-full object-cover rounded-full drop-shadow-2xl transition-transform duration-300 group-hover:scale-110">
                    <div class="absolute bottom-0 right-0 bg-white w-12 h-12 flex items-center justify-center rounded-full shadow-lg z-30 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
            ...
            <div class="relative w-full mt-8 group text-left">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 w-36 h-36 z-20">
                    <img src="{{ asset('images/penyet_display.png') }}" alt="Tempe Penyet" class="w-full h-full object-cover rounded-full drop-shadow-2xl transition-transform duration-300 group-hover:scale-110">
                    <div class="absolute bottom-0 right-0 bg-white w-12 h-12 flex items-center justify-center rounded-full shadow-lg z-30 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
            ...
            <div class="relative w-full mt-8 group text-left">
                <div class="absolute -top-16 left-1/2 -translate-x-1/2 w-36 h-36 z-20">
                    <img src="{{ asset('images/pecel_display.png') }}" alt="Nasi Pecel" class="w-full h-full object-cover rounded-full drop-shadow-2xl transition-transform duration-300 group-hover:scale-110">
                    <div class="absolute bottom-0 right-0 bg-white w-12 h-12 flex items-center justify-center rounded-full shadow-lg z-30 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                        <span class="font-black text-sm text-gray-900">12k</span>
                    </div>
                </div>
        ...
        <a href="{{ url('/menu') }}" class="inline-flex items-center justify-center bg-[#F9A826] text-white px-10 py-3 rounded-full font-bold text-lg shadow-lg shadow-orange-500/20 hover:bg-[#E79A24] transition-transform hover:scale-105 mt-20 tracking-wider">
            Lihat Menu Lainnya
    ...
    {{-- SEKS LAYANAN KAMI: Penjelasan layanan yang tersedia --}}
    <section class="relative container mx-auto px-4 pt-16 text-center">
        ...
        {{-- DAFTAR LAYANAN: Kartu-kartu layanan dengan deskripsi --}}
    ...
    {{-- SEKS FASILITAS: Daftar fasilitas yang tersedia di kafe --}}
    <section class="relative container mx-auto px-4 pt-16 pb-24 text-center">
        ...
        {{-- DAFTAR FASILITAS: Kartu-kartu fasilitas --}}
    ...
    {{-- SEKS TESTIMONI: Ulasan pelanggan dari Google Maps --}}
    <section class="relative container mx-auto px-4 py-16 md:py-24 text-center">
        {{-- JUDUL DAN DESKRIPSI --}}
        <h2 class="text-4xl lg:text-5xl font-bold mb-4">
        ...
        <!-- berdasarkan ulasan gmaps -->
        {{-- LABEL SUMBER ULASAN --}}
        <div class="flex justify-center mb-16">
            <div class="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-5 py-2 shadow-sm">
                {{-- Icon Google Maps --}}
                ...
                <span class="text-sm font-medium text-gray-500">
                    Berdasarkan ulasan di <span class="text-gray-800 font-bold">Google Maps</span>
                </span>
            </div>
        </div>
        ...
        {{-- GRID ULASAN: 3 kolom kartu testimoni --}}
        ...
        <div class="bg-white rounded-[40px] p-8 text-left shadow-lg shadow-gray-500/10 transition-transform duration-300 hover:scale-105">
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/acuy.png') }}" alt="Profil acuy" class="w-16 h-16 rounded-full mr-4 object-cover">
                <div>
        ...
        <div class="bg-white rounded-[40px] p-8 text-left shadow-lg shadow-gray-500/10 transition-transform duration-300 hover:scale-105">
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/ginger.png') }}" alt="Profil Ginger Lovers" class="w-16 h-16 rounded-full mr-4 object-cover">
                <div>
        ...
        <div class="bg-white rounded-[40px] p-8 text-left shadow-lg shadow-gray-500/10 transition-transform duration-300 hover:scale-105">
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/jejhe cacha.png') }}" alt="Profil Maya Putri" class="w-16 h-16 rounded-full mr-4 object-cover">
                <div>
        ...
        {{-- TOMBOL LIHAT TESTIMONI LAINNYA --}}
        <a href="{{ url('/testimoni') }}" class="inline-flex items-center justify-center bg-[#F9A826] text-white px-10 py-3 rounded-full font-semibold text-lg hover:bg-[#E79A24] transition-colors mt-20 shadow-lg shadow-orange-500/20 tracking-wider">
            Lebih Lanjut
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
