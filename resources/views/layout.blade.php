...
<head>
    ...
    <title>@yield('title', 'Kafe Angin Semilir')</title>
        ...
        <header class="sticky top-4 z-50 container mx-auto px-2 py-1">
            ...
            <nav class="flex justify-between items-center bg-white/90 backdrop-blur-sm rounded-full shadow-lg px-4 h-15">
                ...
                <div class="flex items-center space-x-3 pl-3">
                    <img src="{{ asset('images/logo.kafe.png') }}" alt="Logo Kafe" class="w-14 h-14 rounded-full object-cover">
                    <a href="{{ url('/') }}" class="text-base font-bold text-gray-800 hidden lg:block">Kafe Angin Semilir</a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-2">
                    <div class="flex items-center bg-transparent rounded-full">
                        <a href="{{ url('/') }}" class="{{ request()->is('/') ? 'bg-[#F9A826] text-white' : 'text-gray-600 hover:bg-gray-100' }} px-3 py-1.5 rounded-full font-medium transition-colors text-sm">Beranda</a>
                        <a href="{{ url('/profil') }}" class="{{ request()->is('profil') ? 'bg-[#F9A826] text-white' : 'text-gray-600 hover:bg-gray-100' }} px-3 py-1.5 rounded-full font-medium transition-colors text-sm">Profil</a>
                        <a href="{{ url('/menu') }}" class="{{ request()->is('menu') ? 'bg-[#F9A826] text-white' : 'text-gray-600 hover:bg-gray-100' }} px-3 py-1.5 rounded-full font-medium transition-colors text-sm">Menu</a>
                        <a href="{{ url('/kontak') }}" class="{{ request()->is('kontak') ? 'bg-[#F9A826] text-white' : 'text-gray-600 hover:bg-gray-100' }} px-3 py-1.5 rounded-full font-medium transition-colors text-sm">Alamat & Kontak</a>
                        <a href="{{ url('/testimoni') }}" class="{{ request()->is('testimoni') ? 'bg-[#F9A826] text-white' : 'text-gray-600 hover:bg-gray-100' }} px-3 py-1.5 rounded-full font-medium transition-colors text-sm">Testimoni</a>
                    </div>
                    <a href="https://wa.me/6281237064112" class="bg-[#F9A826] text-gray-900 px-4 py-2 rounded-full font-semibold border border-gray-200 hover:bg-gray-100 transition-colors shadow-sm text-xs">
                        Pesan Sekarang
                    </a>
                </div>
                <div class="md:hidden flex justify-between items-center w-full px-3">
                    <a href="{{ url('/') }}" class="text-xl font-bold text-gray-500">Kafe Angin Semilir</a>
                ...
                <div class="grid md:grid-cols-3 gap-12">
                    ...
                    <div>
                        <div class="flex items-center space-x-3 mb-4">
                            <img src="{{ asset('images/logo.kafe.png') }}" alt="Logo Kafe" class="w-24 h-24 rounded-full object-cover">
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="flex space-x-4">
                                <a href="https://www.instagram.com/kafe.anginsemilir/" target="_blank" class="hover:opacity-70 transition-opacity">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="h-8 w-8" fill="currentColor">
                                        <path d="M128 80a48 48 0 1 0 48 48a48.05 48.05 0 0 0-48-48Zm0 80a32 32 0 1 1 32-32a32.036 32.036 0 0 1-32 32Zm52-84a12 12 0 1 1-12-12a12 12 0 0 1 12 12Zm44 12v80a56.063 56.063 0 0 1-56 56H88a56.063 56.063 0 0 1-56-56V88a56.063 56.063 0 0 1 56-56h80a56.063 56.063 0 0 1 56 56Zm-24 0a32.036 32.036 0 0 0-32-32H88a32.036 32.036 0 0 0-32 32v80a32.036 32.036 0 0 0 32 32h80a32.036 32.036 0 0 0 32-32Z" />
                                    </svg>
                                </a>
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/6281237064112" target="_blank" class="flex items-center space-x-3 mb-3 hover:opacity-70 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8" fill="black">
                                    <path d="M12 2a10 10 0 00-8.54 15.41L2 22l4.7-1.24A10 10 0 1012 2zm0 18a8 8 0 01-4.09-1.12l-.29-.17-2.79.74.75-2.72-.18-.28A8 8 0 1112 20zm4.25-5.54c-.23-.11-1.36-.67-1.57-.74-.21-.08-.36-.11-.5.11-.15.23-.57.74-.7.89-.13.15-.26.17-.49.06a6.54 6.54 0 01-1.92-1.18A7.22 7.22 0 019.7 11.2c-.1-.23-.01-.36.08-.47.08-.11.23-.28.34-.42.11-.13.15-.23.23-.39.08-.17.04-.32-.02-.45-.06-.11-.5-1.21-.68-1.66-.18-.45-.36-.38-.5-.39h-.43c-.15 0-.39.06-.6.28-.21.23-.8.78-.8 1.9s.82 2.21.93 2.37c.11.15 1.61 2.46 3.92 3.45.55.24.98.38 1.31.49.55.18 1.05.15 1.45.09.44-.07 1.36-.55 1.55-1.09.19-.53.19-.99.13-1.09-.06-.11-.21-.17-.44-.28z" />
                                </svg>
